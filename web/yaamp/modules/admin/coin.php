...
/* 
echo "<br><a href='/admin/makeconfigfile?id=$coin->id'><b>MAKE CONFIG & START</b></a>";

if($info)
{
	echo "<br><a href='/admin/restartcoin?id=$coin->id'><b>RESTART COIND</b></a>";
	echo "<br><a href='/admin/stopcoin?id=$coin->id'><b>STOP COIND</b></a>";
...
{
	echo "<br><a href='/admin/startcoin?id=$coin->id'><b>START COIND</b></a>";
	echo "<br><br><a href='/admin/resetblockchain?id=$coin->id'><b>RESET BLOCKCHAIN</b></a>";
...
{
	var url = "/admin/coin_results?id={$id}&rows={$maxrows}&since={$since}";
